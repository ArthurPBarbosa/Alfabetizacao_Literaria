...
from .constants import DRAWTYPE_POINT
from .constants import DRAWTYPE_CIRCLE
from .constants import DRAWTYPE_LINE
from .constants import DRAWTYPE_SCALELINE
from .constants import DRAWTYPE_BUBBLE
from .constants import DRAWTYPE_IMAGE
from .constants import INTERPOLATIONTYPE_COSINE
from .constants import UNIVERSAL_CONSTANT_OF_MAKE_GRAVITY_LESS_STUPIDLY_SMALL
from .constants import VORTEX_ACCELERATION
from .constants import VORTEX_SWALLOWDIST
from .constants import RADIUS_PERMITTIVITY
from .constants import INTERPOLATIONTYPE_LINEAR

import sys, pygame, xml
...
class ParticleEffect:
	...
	def Redraw(self):
		...
		#for p in self.particles:
			#pygame.draw.circle(self.display, (255, 255, 255), (int(p.pos[0]), int(p.pos[1])), 5)

        
		vivos = [p for p in self.particles if p.alive]
		#print(f"[DEBUG] Redraw: {len(vivos)} partículas vivas")
		for particle in vivos:
			#print(f"[DEBUG] Partícula pos={particle.pos}, raio={particle.radius}, cor={particle.colour}")
