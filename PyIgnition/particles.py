...
class Particle:
	...
	def Draw(self, display):
		#print(f"[DRAW] drawtype={self.drawtype}, pos={self.pos}, radius={self.radius}")
		...
		if self.drawtype == DRAWTYPE_POINT:  # Point
			...
			pygame.draw.circle(display, self.colour, (offset[0] + int(self.pos[0]), offset[1] + int(self.pos[1])), max(1, int(self.radius)))
		...
		# print(f"[DRAW] pos={self.pos}, raio={self.radius}, cor={self.colour}, tipo={self.drawtype}")
